...
---
1.
<img width="854" height="1025" alt="image" src="https://github.com/user-attachments/assets/14e80039-3244-4864-a5ac-38d3d2d8cdb4" />

2.
<img width="1487" height="763" alt="image" src="https://github.com/user-attachments/assets/f30a8d1c-e9a8-44d5-b6d7-92457b1de918" />

3. 
<img width="776" height="526" alt="image" src="https://github.com/user-attachments/assets/ab57c844-1cba-4462-b786-c3ffc0dd237e" />
<img width="639" height="603" alt="image" src="https://github.com/user-attachments/assets/f71fb3cd-f0a4-4b7f-8c38-6c9494fed55b" />
  ...
  template:
    ...
    spec:
      ...
      - name: busybox
        ...
        command: ["/bin/sh", "-c"]
        args: ["while true; do echo \"$(date) - Hello from busybox via PV\" >> /data/shared.txt; sleep 5; done"]
        volumeMounts:
        - name: pv-storage
          mountPath: /data
      - name: multitool
...
***
1.
<img width="902" height="143" alt="image" src="https://github.com/user-attachments/assets/315fae1e-4e19-4e52-88a7-1912e328e80b" />

2.
<img width="905" height="304" alt="image" src="https://github.com/user-attachments/assets/032cd151-c667-4953-a3fd-8b5035f64c85" />

3. 
<img width="402" height="590" alt="image" src="https://github.com/user-attachments/assets/7319e0d1-2c15-46fc-889b-36c18aa586f3" />
...
---
1.
<img width="905" height="546" alt="image" src="https://github.com/user-attachments/assets/70e06278-5837-433d-b311-8b3b8b8c13bc" />

2.
<img width="889" height="451" alt="image" src="https://github.com/user-attachments/assets/df6f498f-d76e-4a0c-800f-66b3d03086aa" />
  ...
  template:
    ...
    spec:
      ...
      - name: busybox
        image: busybox:latest
        command: ["/bin/sh", "-c"]
        args: ["while true; do echo \"$(date) - Hello from busybox via SC\" >> /data/shared.txt; sleep 5; done"]
        volumeMounts:
        - name: sc-storage
          mountPath: /data
      - name: multitool
